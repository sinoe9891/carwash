							...
							<form class="form" id="editarUsuario" method="post" action="inc/models/insert.php" role="form">
								<div class="tab-content" id="myTabContent">
													...
													<div class="row">
														...
														<div class="col-md-6 col-12">
															<div class="form-group">
																...
																<input type="tel" class="form-control" id="celular1" name="celular1" value="" required>
															</div>
														</div>
														<div class="col-md-6 col-12">
															<div class="form-group">
																<label for="first-name-column">Identidad</label>
																<input type="text" class="form-control" id="identidad" name="identidad" value="" required>
															</div>
														</div>
														<div class="col-md-6 col-12">
															<div class="form-group">
																...
																<select class="form-select" name="genero" id="genero">
																	<option name='genero' value='M' selected>Masculino</option>
									...
									<div class="col-12 d-flex justify-content-end">
										<input type="hidden" class="btn btn-primary me-1 mb-1" id="tipo" name="accion" value="newCliente">
